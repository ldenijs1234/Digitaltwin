...
%outputs
function v_vent = calculate_ventilation_rate(A, roof_angle, theta, number_of_windows, l, h, C_f, g, beta, c_air, rho)
    % Constants
    ...
    Tout = 20; % Outside temperature in degrees Celsius
