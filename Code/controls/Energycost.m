...
function [cost, day1cost, price_array_W4, time_hours, price_forecast, new_time_hours] = Energycostt(filename, dt, total_time)
    ...
    new_time_hours = 0:dt/3600:24*21;
...
[cost, day1cost, price_array_W4, time_hours, price_forecast, new_time_hours] = Energycostt(filename, dt, total_time);
