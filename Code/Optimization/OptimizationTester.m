...
% dates = ["2024-01-16.csv", "2024-01-24.csv", "2024-02-01.csv", "2024-02-16.csv",...
%     "2024-02-24.csv", "2024-03-03.csv", "2024-03-11.csv", 
% dates = ["2024-03-26.csv", "2024-04-03.csv",...
%     "2024-04-18.csv", "2024-04-26.csv", "2024-05-02.csv", "2024-05-19.csv", 
dates = ["2024-05-21.csv",...
    "2024-05-27.csv", "2024-05-30.csv", "2024-06-04.csv", "2024-06-12.csv", "2024-06-20.csv"];

%days = ["2023-10-14", 
%days = ["2023-10-29", "2023-11-06", "2023-11-21", "2023-11-28",... 
%    "2023-12-07", "2023-12-15", "2023-12-23", "2023-12-31", "2024-01-01",...
% days = ["2024-01-16", "2024-01-24", "2024-02-01", "2024-02-16",...
%     "2024-02-24", "2024-03-03", "2024-03-11", 
% days = ["2024-03-26", "2024-04-03",...
%     "2024-04-18", "2024-04-26", "2024-05-02", "2024-05-19", 
days = ["2024-05-21",...
    "2024-05-27", "2024-05-30", "2024-06-04", "2024-06-12", "2024-06-20"];

results = "results3.xlsx";
